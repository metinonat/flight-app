...
- `sort` : sorting flights by their:
 ...
 -  `order` : ordering flights by their `sort` value. Custom ordering for multiple sort fields can be provided as "101101" where each 1 or 0 corresponds respective sort field. 1 is for ascending and 0 is for descending.
...
- `sort` : supported sorting fields are:
  ...
  - icao, and
  - nvls
-  `order` : ordering airlines by their `sort` value. Custom ordering for multiple sort fields can be provided as "101101" where each 1 or 0 corresponds respective sort field. 1 is for ascending and 0 is for descending
- `page` : page number for the result.
